...
class FightResult(Base):
    ...
    promotion: Mapped[str | None] = mapped_column(String(120), nullable=True)
    weight_class: Mapped[str | None] = mapped_column(String(80), nullable=True)
    scheduled_rounds: Mapped[int | None] = mapped_column(Integer, nullable=True)
