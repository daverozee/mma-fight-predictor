...
def run_once(catalog_path: str | None = None) -> DataImportSummary | None:
    ...
    logger.info(
        ...
        "current_fights=%s live_fights_seen=%s live_fights_imported=%s "
        "live_fights_skipped=%s historical_fights=%s media_overrides=%s media_generated=%s "
        "media_found=%s media_verified=%s media_broken=%s fighters=%s external_features=%s",
        elapsed,
        summary.records_seen,
        summary.features_imported,
        summary.profiles_promoted,
        summary.current_fights_imported,
        summary.live_fights_seen,
        summary.live_fights_imported,
        summary.live_fights_skipped,
